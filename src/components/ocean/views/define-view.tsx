...
import { IcpAttributes } from '../icp-summary-card'
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Agent 1 scores every lead against this profile. Edit it any time — both agents read it.
        </CardDescription>
      </CardHeader>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <p className="text-xs text-muted-foreground mt-2">
          Re-seeding restores the original demo dataset: 6 leads, 8 candidates, 1 active JD, 1 job
          target, sample briefs, and ICP defaults. You can also re-seed from the top bar at any time.
        </p>
      </CardContent>
    </Card>
  )
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Configure the rules both agents follow.
        </p>
      </div>
